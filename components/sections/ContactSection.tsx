...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 relative z-10 max-w-6xl mx-auto px-6 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20">
        ...
        <div className="lg:col-span-5 flex flex-col gap-8">
          <div>
            <h3 className="text-2xl font-bold text-zinc-100 mb-4">Have a project in mind?</h3>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-4 p-4 rounded-xl bg-zinc-900/40 border border-zinc-800/80 backdrop-blur-sm">
              ...
              <div>
                ...
                <Link href="mailto:osman.developer@example.com" className="text-sm md:text-base text-zinc-300 hover:text-cyan-400 transition-colors">
            ...
            <div className="flex items-center gap-4 p-4 rounded-xl bg-zinc-900/40 border border-zinc-800/80 backdrop-blur-sm">
              ...
              <div>
                ...
                <span className="text-sm md:text-base text-zinc-300">Egypt</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 pt-4">
            <Link href="https://github.com/AbdoDeveloper" target="_blank" className="w-10 h-10 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:border-zinc-700 transition-all">
              <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
            </Link>
            <Link href="https://linkedin.com/in/AbdoDeveloper" target="_blank" className="w-10 h-10 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:border-zinc-700 transition-all">
        ...
        <div className="lg:col-span-7">
          <motion.form 
            ...
            className="space-y-5 p-6 md:p-8 rounded-2xl bg-[#0c0c0e]/95 border border-zinc-800/90 backdrop-blur-xl shadow-2xl"
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="space-y-2">
                <label className="text-xs font-medium text-zinc-400">Your Email</label>
                <input 
                  type="email"
                  required
      ...
      <div className="pt-8 border-t border-zinc-900 flex flex-col sm:flex-row items-center justify-between gap-4 w-full text-zinc-500 text-xs select-none">
        <div>
          &copy; {new Date().getFullYear()} Abdo. All rights reserved.
        </div>
