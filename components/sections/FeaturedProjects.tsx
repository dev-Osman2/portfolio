...
export default function FeaturedProjects() {
  ...
  return (
    <section id="projects" className="py-20 relative z-10 max-w-7xl mx-auto px-6">
      {/* العنوان */}
        ...
        <div className="lg:col-span-4 flex flex-col gap-3">
          {projectsData.map((project) => (
            ...
            >
              ...
              <h3 className={`font-bold text-lg ${activeTab === project.id ? "text-zinc-100" : "text-zinc-400"}`}>
                {project.title}
              </h3>
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="w-full bg-[#121214] border border-zinc-800 rounded-xl overflow-hidden shadow-2xl"
            >
              {/* شريط الماك العلوي للأزرار الثلاثة */}
              <div className="bg-[#18181c] px-4 py-3 border-b border-zinc-800/80 flex items-center justify-between">
              ...
              <div className="relative aspect-video bg-zinc-950 flex items-center justify-center overflow-hidden group">
                <div 
                  className="w-full h-full bg-zinc-900 flex flex-col items-center justify-center text-center p-8 border-b border-zinc-800 select-none"
                  style={{
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h4 className="text-2xl font-bold text-zinc-200">{activeProject.title}</h4>
                  </div>
                </div>
              </div>

              {/* تفاصيل المشروع والتقنيات بالأسفل */}
              <div className="p-6 md:p-8 bg-[#121214]">
                <h3 className="text-xl font-bold text-zinc-100 mb-2">{activeProject.title}</h3>
